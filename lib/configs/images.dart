...
class AppImages {
  ...
  static const thumbnail_unite = _Image('unite.png');
  static const thumbnail_sv = _Image('scarlet.png');
  static const thumbnail_sleep = _Image('sleep.png');
  static const thumbnail_violet = _Image('violet.png');
  static const thumbnail_presents = _Image('pokepresents.png');
  static const thumbnail_pmex = _Image('pmex.png');
