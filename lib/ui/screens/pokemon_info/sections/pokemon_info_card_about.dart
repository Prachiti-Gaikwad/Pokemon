...
class _Label extends Text {
  _Label(String text, bool isDark)
      : super(
          text,
          style: TextStyle(
            color: isDark ? AppColors.black.withOpacity(1.0) : AppColors.black.withOpacity(1.0),
            height: 0.8,
          ),
        );
}
...
class _PokemonAbout extends StatelessWidget {
  ...
  Widget _buildBreeding(PokemonGender gender, List<String> eggGroups, bool isDark) {
    return _ContentSection(
      label: Text('Breeding:',style: TextStyle(height: 0.8, color: Colors.black),),
      children: [
        Row(
          children: <Widget>[
        ...
        Row(
          children: <Widget>[
            ...
            Expanded(
              flex: 2,
              child: Text(eggGroups.join(', '), style: TextStyle(height: 0.8, color: Colors.black)),
            ),
  ...
  Widget _buildTraining(double baseExp, bool isDark) {
    return _ContentSection(
      label: Text('Training', style: TextStyle(height: 0.8, color: Colors.black),),
      children: [
        Row(
          children: <Widget>[
